<div class="flex flex-col sm:flex-row relative gap-16 -mx-5 md:mx-0">
    <!-- text -->
    <div class="w-full md:w-1/2 flex flex-col justify-center bg-[url('https://images.pexels.com/photos/1983036/pexels-photo-1983036.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')] bg-cover md:bg-none text-center md:text-left">
    ...
    <!-- text -->
    <!-- image -->
    <div class="hidden md:w-1/2 md:flex items-center gap-3 md:gap-6">
