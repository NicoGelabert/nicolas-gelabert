<x-guest-layout>
	<div class="container max-w-full" id="curriculum-vitae">
		<div class="carousel">
			<div class="carousel__wrapper">
				<div class="carousel__header">
					<h2 class="carousel__headline">01 | {{__('Curriculum')}}</h2>
				...
				<div class="flex flex-col mb-16">
					...
					<div class="subtitle flex justify-end sticky bottom-8 right-0 -z-[3]">
						<h3 class="relative origin-center text-3xl sm:text-6xl md:text-7xl font-semibold opacity-10 uppercase">{{__('Experiencia')}}</h3>
					</div>
				</div>
				<div class="flex flex-col">
					...
					<div class="subtitle flex justify-end sticky bottom-8 right-0 -z-[3]">
						<h3 class="relative origin-center text-3xl sm:text-5xl md:text-7xl font-semibold opacity-10 uppercase">{{__('Educación')}}</h3>
					</div>
				</div>
			</div>
		</div>
